'''O sistema de login permite que novos usuários sejam cadastrados e que usuários existentes possam fazer o login. O sistema deve alertar caso a senha e login não estejam corretos.'''

# Usuário deve escolher entre criar um novo perfil ou acessar um já existente
resposta = input('"1" - Cadastrar novo usuário | "2" - Fazer login: ')
# Criando duas listas, respectivamente, com três usuários e senhas
usuarios = ['Ivern','Garen','Darius']
